...
import com.liugl.alltest.mulitthread.SynchronizedListActivity;
...
import com.liugl.alltest.trycatch.TryCatchOOmActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button suanfa;
    @BindView(R.id.activity_try_catch_oom_div)
    Button activityTryCatchOomDiv;
    @BindView(R.id.synchronizedList)
    Button synchronizedList;
    @BindView(R.id.changeDB)
    Button changeDB;
    ...
    @BindView(R.id.popWindowBtn)
    Button popWindowBtn;

    @BindView(R.id.binderAidleBtn)
    Button binderAidleBtn;

//    @BindView(R.id.tbn_app)binderAidleBtn
//    Button tbnApp;
 ...
 /*       if (tbnApp!=null){
    ...
    @OnClick({R.id.binderAidleBtn,R.id.rececyview_jiazai, R.id.popWindowBtn, R.id.animationBtn, R.id.acacheTest, R.id.changeDB, R.id.synchronizedList,
...
//                startActivity(window_appItent);
            ...
            case R.id.activity_suanfa_div:
                ...
                break;
            case R.id.activity_try_catch_oom_div:
                Intent try_catch_oom = new Intent(this, TryCatchOOmActivity.class);
                startActivity(try_catch_oom);
                break;
            case R.id.synchronizedList:
                Intent synchronizedList = new Intent(this, SynchronizedListActivity.class);
                startActivity(synchronizedList);
                break;
            case R.id.changeDB:
                Intent dbIntent = new Intent(this, DBActivity.class);
                startActivity(dbIntent);
                break;
            case R.id.acacheTest:
            ...
            case R.id.popWindowBtn:
                Intent popWindowBtnIntent = new Intent(this, PopWindwoActivity.class);
                startActivity(popWindowBtnIntent);
                break;
