package com.liugl.alltest.view.selfdefineview.baiduloading;
...
public class Wave extends View {
    ...
    private int mWidth = CommonUtils.dip2px(getContext(), 50);
    private int mHeight = CommonUtils.dip2px(getContext(), 50);
    private int textSize = CommonUtils.sp2px(getContext(), 25);
