...
public class QSpringActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qspring);
        movingView = findViewById(R.id.animation_image);
    ...
    SpringAnimation createSpringAnimation(View view,
                                          ...
                                          Float finalPosition,
                                          @FloatRange(from = 0.1) Float stiffness,
